...
{		
 ...
 <div class="form-group">
      ...
      <div class="col-sm-6">
         <input type="date" class="form-control" value="<?php echo $debut; ?>" id="firstname" name="debut" placeholder="date de debut">
      ...
      <div class="col-sm-6">
         <input type="date" class="form-control" value="<?php echo $fin; ?>" id="firstname" name="fin" placeholder="date de fin">
